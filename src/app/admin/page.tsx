            ...
            <div>
              ...
              <CldUploadWidget
                ...
                onError={(error) => {
                  ...
                  setIsUploading(false)
                  toast.error('Image upload failed. Please check credentials.', {
                    icon: <XCircle className="w-5 h-5 text-red-500" />
                  })
                }}
              >
                {({ open }) => (
                  <div className="space-y-4">
                    <button
                      ...
                      className="bg-gray-700 px-4 py-2 rounded hover:bg-gray-600 disabled:opacity-50 flex items-center gap-2"
                    >
                      {isUploading ? (
                        <>
                    ...
                    {imageUrl && !isUploading && (
                      <div>
                        <img
                          src={imageUrl}
                          alt="Preview"
                          className="w-full max-h-48 object-cover rounded border border-gray-700"
                        />
                      </div>
                    )}
                  </div>
