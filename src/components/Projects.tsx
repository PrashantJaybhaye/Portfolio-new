        ...
        <div className='mb-8 flex flex-wrap lg:justify-center md:items-center'>
          <motion.div
            ...
            <a href='https://Valentino.waliilaw.me'>
              <img src='/valentino.jpg' width={500} height={500} alt="LiveDox" className='mb-6 rounded-xl max-w-full h-auto mx-auto lg:mx-[-100px] shadow-lg' />
            </a>
        ...
        <div className='mb-8 flex flex-wrap lg:justify-center md:items-center'>
          <motion.div
            ...
            <a href='https://github.com/waliilaw/Power-Rangers-FRONTEND--PUBLIC?tab=readme-ov-file'>
              <img src='/rangers.jpg' width={500} height={500} alt="9otes" className='mb-6 rounded-xl max-w-full h-auto mx-auto lg:mx-[-100px] shadow-lg' />
            </a>
          </motion.div>
          <motion.div
